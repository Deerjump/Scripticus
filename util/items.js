module.exports = {
  ...
  OilBarrel1: {
    ...
    sources: ['Glumlee2', 'Blunder Hills'],
  },
  OilBarrel2: {
    name: 'Toxic Sludge',
    sellPrice: 20,
  ...
  FoodHealth1: {
    ...
    sources: ['Green_Mushroom', 'Blunder Hills', 'DropTable1', 'Scripticus4'],
  },
  FoodHealth3: {
    name: 'Hot Dog',
    sellPrice: 7,
    ...
    sources: ['Encroaching Forest Villas', 'DropTable2', 'Blunder Hills'],
  },
  FoodHealth2: {
    name: 'Cheezy Pizza',
    sellPrice: 20,
  ...
  Meatloaf: {
    ...
    sources: ['Chaotic_Amarok', 'Nightmare_Amarok', 'Amarok'],
  },
  FoodPotOr1: {
    ...
    sources: ['DropTable5', 'DropTable11', 'DropTable12', 'Blunder Hills'],
  },
  FoodPotOr2: {
    ...
    sources: ['Encroaching Forest Villas', 'Yumyum Grotto', 'DropTable2'],
  },
  FoodPotOr3: {
  ...
  FoodPotRe2: {
    ...
    sources: ['Yumyum Grotto', 'Picnic_Stowaway4', 'Gigafrog'],
  },
  FoodPotRe3: {
  ...
  FoodPotGr1: {
    ...
    sources: ['DropTable10', 'DropTable4', 'DropTable2', 'Blunder Hills'],
  },
  FoodPotGr2: {
  ...
  FoodPotMana1: {
    ...
    sources: ['Frog', 'DropTable1', 'Blunder Hills'],
  },
  FoodPotMana2: {
  ...
  FoodPotYe1: {
    ...
    sources: ['Encroaching Forest Villas', 'Plan-it Express'],
  },
  FoodPotYe2: {
  ...
  FoodEvent1: {
    ...
    sources: ['Meaning_of_Giftmas', 'Giftmas_Blobulyte', 'Ghost'],
  },
  FoodChoppin1: {
    name: 'Saucy Logfries',
    sellPrice: 10,
  ...
  MidnightCookie: {
    ...
    sources: ['Efaunt', 'DropTable8', 'Nightmare_Amarok', 'Chaotic_Efaunt'],
  },
  PeanutG: {
    name: 'Golden Peanut',
    sellPrice: 125,
  ...
  FoodG4: {
    ...
    sources: ['Colosseum', 'Plan-it Express', 'SuperDropTable1'],
  },
  rtt0: {
  ...
  ResetCompleted: {
    ...
    sources: ['Promotheus3', 'Promotheus2', 'Speccius1', 'Funguy1', 'Hamish2'],
  },
  ResetCompletedS: {
  ...
  ExpBalloon2: {
    ...
    description:
      "Hold down to gain EXP in the skill that's displayed in the corner of your screen. If you're in a town, you will gain EXP in the town skill. The amount of EXP you get is based on your skill's Lv.",
    sources: ['Tiki_Chief3', 'Cowbo_Jones12'],
  },
  ExpBalloon3: {
  ...
  EquipmentStatues2: {
    ...
    sources: ['Stiltzcho1', 'Krunk3', 'Stiltzcho2', 'Papua_Piggea4'],
  },
  EquipmentStatues3: {
    name: 'Mining Statue',
    sellPrice: 10,
  ...
  EquipmentStatues4: {
    ...
    sources: ['Plan-it Express', 'Simple Shippin'],
  },
  EquipmentStatues5: {
    name: 'Health Statue',
    sellPrice: 10,
  ...
  EquipmentStatues6: {
    ...
    sources: ['Plan-it Express', 'Picnic_Stowaway6', 'Tiki_Chief1'],
  },
  EquipmentStatues7: {
  ...
  EquipmentStatues8: {
    ...
    sources: ['Sprout1', 'DropTable11', 'DropTable9'],
  },
  EquipmentStatues9: {
  ...
  StampA15: {
    ...
    type: 'STAMP',
    description:
      'BaseLUK,add,1,0,2,EquipmentShirts12,1,1.7,1000,1.6,0,{} LUK,6',
  ...
  StampA18: {
    ...
    type: 'STAMP',
    description:
      'PctMoveSpd,decay,8,40,5,Copper,25,6,50,1.3,0,{} Base Move Speed,0',
  },
  StampA19: {
    name: 'Polearm Stamp',
    sellPrice: 1,
    ...
    type: 'STAMP',
    description:
      'PctDmg,decay,16,40,6,PlatBar,20,6,3000,1.3,0,{}% Total Damage,0',
    sources: ['Papua_Piggea4'],
  },
  StampA20: {
    name: 'Violence Stamp',
    ...
    type: 'STAMP',
    description:
      'PctSTR,decay,20,40,4,Copper,25,6,50,1.3,0,{}% STR from Talents,0',
  },
  StampA21: {
    name: 'Buckler Stamp',
    sellPrice: 1,
  ...
  StampA23: {
    ...
    type: 'STAMP',
    description:
      'BossDmg,decay,24,60,10,Fish3,120,7,2500,1.34,0,{}% Boss Damage,0',
  },
  StampA24: {
    name: 'FILLER',
    sellPrice: 1,
  ...
  StampA26: {
    ...
    type: 'STAMP',
    description:
      'PctDmg,decay,25,60,10,Bug4,100,5,10000,1.32,0,{}% Total Damage,0',
    sources: ['Mutton4'],
  },
  StampA27: {
    name: 'FILLER',
  ...
  StampB12: {
    ...
    type: 'STAMP',
    description:
      'BaseChopEff,add,2,0,10,EquipmentTools3,25,6,125,1.4,3,{} Choppin Efficiency,0',
  },
  StampB13: {
    ...
    type: 'STAMP',
    description:
      'SmithExp,add,1,0,5,ForestTree,25,6,80,1.35,2,{}% Smithing Exp,0',
    sources: ['DropTable11'],
  },
  StampB14: {
    name: 'Choppin Stamp',
  ...
  StampC3: {
    ...
    type: 'STAMP',
    description:
      'CrySpawn,decay,110,50,10,Copper,25,6,50,1.3,0,{}% Spawn Chance,3',
    sources: ['Crystal_Crabal', 'Crystal_Carrot'],
  },
  StampC4: {
    name: 'Blank',
    sellPrice: 1,
  ...
  StoneW3: {
    ...
    sources: ['Colosseum', 'Dudes Next Door'],
  },
  StoneW6: {
    ...
    sources: ['Bandit_Bob1', 'Funguy5', 'Goldric4'],
  },
  StoneA1: {
  ...
  StoneHelm1: {
    ...
    sources: ['Glublin', 'Plan-it Express', 'Simple Shippin'],
  },
  StoneHelm6: {
    ...
    sources: ['Cowbo_Jones9', 'Picnic_Stowaway10'],
  },
  StoneHelm1b: {
  ...
  DesertC1: {
    ...
    id: 0,
    type: 'MONSTER_DROP',
    sources: ['Bloque', 'Thermister', 'Tyson'],
  },
  DesertC2: {
    name: 'Wakka Cherry',
    sellPrice: 160,
  ...
  Timecandy2: {
    ...
    sources: ['Gem Shop', 'Postboy_Pablob1', 'Speccius1', 'Giftmas_Blobulyte1'],
  },
  Timecandy3: {
    ...
    sources: ['Gem Shop', 'Desert_Davey2'],
  },
  Timecandy4: {
  ...
  Key1: {
    ...
    sources: ['Colosseum', 'Dog_Bone1', 'Simple Shippin', 'Plan-it Express'],
  },
  Key2: {
  ...
  Weight1: {
    ...
    description:
      'Hold down to add this accessory to it to your fishing toolkit, where it can be accessed by "ALL" characters!',
    sources: ['Whattso1', 'Faraway Piers'],
  },
  Weight2: {
    name: 'Iron Hook',
    sellPrice: 50,
  ...
  CardsZ2: {
    ...
    sources: ['Nightmare_Amarok', 'Amarok'],
  },
  CardsZ3: {
    name: 'Efaunt Card',
    sellPrice: 1,
    ...
    sources: ['Efaunt', 'Error', 'Nightmare_Amarok', 'Chaotic_Efaunt'],
  },
  CardsZ4: {
